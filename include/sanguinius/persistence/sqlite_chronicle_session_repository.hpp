...
public:
  ...
  [[nodiscard]] WorkMutationStatus complete_summary_job(
  ...
  [[nodiscard]] std::optional<SummaryControlResolution>
  ...
  list_titles(const DiscordSnowflake &viewer, const DiscordSnowflake &target,
              bool owner_view, std::size_t page) override;
  [[nodiscard]] ChronicleSearchPage begin_search(
  ...
  [[nodiscard]] ChronicleSearchPage advance_search(
  ...
  [[nodiscard]] bool queue_anniversary_scan(

          ...
          CommandSubcommandGroupDefinition{
              ...
              .subcommands =
                  {{"disconnect",
                   ...
                   {"speech-test",
                    "Exercise one deterministic speech scenario.",
                    {{CommandOptionKind::string,
                      "scenario",
                      "Speech test scenario.",
                      true,
                      5,
                      18,
                      {{"Queue ordering", "queue"},
                       ...
                       {"Narration stale restart", "narration-stale"}}}}},
                   {"narration-preview",
                    "Inspect one privacy-gated narration projection.",
                    {{CommandOptionKind::string, "reference",
                      "Full source-event UUID.", true, 36, 36}}},
                   {"narration-enqueue",
                    "Observe one eligible owner-test narration event.",
                    {{CommandOptionKind::string, "reference",
                      "Full source-event UUID.", true, 36, 36}}},
                   {"narration-recent",
